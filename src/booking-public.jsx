    ...
    return <div className="bk-wrap">{styleTag}
      <div className="bk-inner">
        ...
        <div style={{ marginTop: 26 }}>
          ...
          {stores.map((s) => (
            <div key={s.id} className="store-card" style={{ cursor: s.address ? "pointer" : "default" }} onClick={() => { if (s.address) window.open("https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent(s.name + " 髮型屋 " + s.address), "_blank", "noopener"); }}>
